...
<body>
    <div class="wrapper">
        ...
        <!------>
        <script src="{{ asset('new/assets/bundles/datatables/datatables.min.js') }}"></script>

        <script src="{{ asset('new/assets/js/page/datatables.js') }}"></script>
